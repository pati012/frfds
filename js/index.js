   ...
   window.addEventListener('scroll', function (e){
    ...
    function lazyLoading(){
      ...
      const buttonPopupHouse = document.querySelector('.popup__btn-agree-house');
       ...
       const buttonPopupFooter = document.querySelector('.form-footer__btn');
       buttonPopupFooter.addEventListener('click', function submits(e){
          const form = document.forms[0];
         ...
         const inputCheckBox = form.elements.agree;   
            ...
            if(!inputCheckBox.checked){
              const currentCheckBox = document.querySelector('.form-footer__input-check');
               const cupturePopup = document.querySelector('.footer__capture');
                if(!cupturePopup.classList.contains('popup__error')){
                    const popupError = document.querySelector('.popup__error');
                    popupError.style.display = 'block';
                   setTimeout(function (e){
         ...
         const scrollSection = document.querySelector('.info__arrow');
          ...
          //scroll up footer to header 
           ...
           const cardBuildSection = document.querySelector('.footer');
            if(cardBuildSection){
            window.addEventListener('scroll', function (e){
                ...
                for(let item = 0; item < spoller.length; item++){
                  ...
                  element.addEventListener('click', function (e){
                    ...
                    if (elementOpen.style.maxHeight == "") {
                          ...
                          const elementCloses = document.querySelectorAll('.spoller__close');
                          elementCloses.forEach(item => {
                            item.classList.add('spoller-open');
                        });
